...
const achievements = [
  ...
  },
  {
    ...
    color: "text-[var(--accent-olive-dark)]",
  },
  {
    icon: Mic,
      ...
      <div className="section-container">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {achievements.map((item, i) => {
            ...
            >
                <div className="flex flex-col items-center text-center gap-4">                    <div className="card-icon-wrapper w-12 h-12 rounded-lg bg-[rgba(124,138,58,0.1)] flex items-center justify-center flex-shrink-0">
