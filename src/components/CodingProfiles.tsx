                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center gap-4">
                      <div className="card-icon-wrapper w-14 h-14 rounded-xl bg-[rgba(249,115,22,0.1)] flex items-center justify-center group-hover:bg-[rgba(249,115,22,0.15)] transition-colors">
                        <Icon size={28} />
                      </div>
                      <div>
                      ...
                      <div className="mt-1 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[rgba(249,115,22,0.06)] border border-[rgba(249,115,22,0.1)] group-hover:border-[rgba(249,115,22,0.3)] transition-all">
                        <span className="text-[0.55rem] font-mono text-[var(--accent-orange)] font-medium tracking-wide uppercase">Visit</span>
                        <ExternalLink size={12} className="text-[var(--accent-orange)] icon-arrow" />
                      </div>
                    </div>
                  </a>
                );
