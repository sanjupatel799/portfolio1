...
const counters = [
  { value: 3, suffix: "+", label: "Projects Delivered", color: "text-[var(--accent-purple)]" },
  { value: 1, suffix: "", label: "Internship Completed", color: "text-[var(--accent-lavender)]" },
  { value: 85, suffix: "%+", label: "AI Model Accuracy", color: "text-[var(--accent-purple-dark)]" },
  { value: 2026, suffix: "", label: "Graduate", color: "text-[var(--accent-purple)]" },
];
...
function AnimatedCounter({ value, suffix, label, color }: { value: number; suffix: string; label: string; color: string }) {
  ...
  return (
    <div ref={ref} className="text-center p-10 flex flex-col gap-3 glass rounded-xl transition-all duration-300 hover:border-[var(--accent-purple)] hover:-translate-y-1">
...
export default function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="relative py-44 md:py-52 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-16">
          <div className="reveal-left space-y-4">
            <p className="text-sm md:text-[0.95rem] text-[var(--text-secondary)] leading-[1.9]">
              ...
              internship and developed AI models achieving <strong className="text-[var(--accent-purple)]">85%+ prediction accuracy</strong>.
            </p>
            <p className="text-sm md:text-[0.95rem] text-[var(--text-secondary)] leading-[1.9]">
            ...
            <p className="text-sm md:text-[0.95rem] text-[var(--text-secondary)] leading-[1.9]">
              Looking for a <strong className="text-[var(--accent-purple)]">Fresher Software Developer</strong> or{" "}
              <strong className="text-[var(--accent-purple)]">Full Stack Developer</strong> role where I can contribute
          ...
          <div className="reveal-right">
            <div className="hover-card-glow glass rounded-xl p-12 flex flex-col gap-4 text-center">
              ...
              <div className="border-b border-[var(--border-color)] pb-4">
                ...
                <div className="text-sm font-medium text-[var(--accent-purple)] break-all">bandarisanjaykumar8@gmail.com</div>
              </div>
              <div>
        ...
        <div className="mt-16 reveal">
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {["Problem Solving", "Communication", "Team Collaboration", "Adaptability", "Time Management", "Continuous Learning"].map((skill) => (
              <span key={skill} className="px-3.5 py-1.5 glass text-xs font-mono text-[var(--text-secondary)] rounded-md hover:border-[var(--accent-purple)] hover:text-[var(--accent-purple)] transition-all duration-200">
                {skill}
              </span>
            ))}
          </div>
